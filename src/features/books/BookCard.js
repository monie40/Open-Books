...
const BookCard = ({book}) => {
    ...
    const {author_name, ebook_access, first_publish_year, title, ratings_average, isbn } = book;
    const picSrc = 'https://covers.openlibrary.org/b/isbn/'+ isbn[0] + '-L.jpg'
    
    return(
            <Card>
                <CardImg width = '100%' src = {picSrc} alt = 'Picture of book' />
